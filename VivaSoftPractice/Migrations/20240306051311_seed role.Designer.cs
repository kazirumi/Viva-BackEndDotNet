...
namespace VivaSoftPractice.Migrations
{
    ...
    [Migration("20240306051311_seed role")]
            ...
            modelBuilder.Entity("VivaSoftPractice.Model.Role", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("9e2a6312-9e23-43af-9576-57063ea973c6"),
                            Name = "Admin"
                        },
                        new
                        {
                            Id = new Guid("b5f8026f-1eaf-43e7-8060-a83af2ece4d4"),
                            Name = "User"
                        },
                        new
                        {
                            Id = new Guid("6951914f-f99c-4f8c-ac96-52f7d5a8ede1"),
                            Name = "Organizer"
                        });
                });
